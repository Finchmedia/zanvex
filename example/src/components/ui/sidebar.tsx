    ...
    return (
      <>
        ...
        <div
          ...
          data-mobile="true"
          className={cn(
            "bg-sidebar text-sidebar-foreground fixed inset-y-0 z-50 flex h-svh w-[--sidebar-width] flex-col transition-transform duration-200",
...
function SidebarInput({
  ...
  return (
    <input
      ...
      data-sidebar="input"
      className={cn(
        "bg-background focus-visible:ring-sidebar-ring h-8 w-full rounded-md border px-3 text-sm shadow-none outline-hidden transition-[width,height,padding] focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50",
    ...
    >
      {showIcon && (
        <div
          ...
          className="bg-sidebar-accent-foreground/10 size-4 rounded-md"
        />
      )}
      <div
